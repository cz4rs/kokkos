...
FUNCTION(KOKKOS_ADD_EXECUTABLE_AND_TEST ROOT_NAME)
    ...
    IF (KOKKOS_HAS_TRILINOS)
        ...
        ENDIF()
        IF (${PARSE_CATEGORIES} MATCHES "PERFORMANCE")
          SET(KOKKOS_BENCHMARK_TESTONLY_LIB ${KOKKOS_BENCHMARK_LIB})
        ELSE()
          SET(KOKKOS_BENCHMARK_TESTONLY_LIB "")
        ENDIF()
        TRIBITS_ADD_EXECUTABLE_AND_TEST(
            ${ROOT_NAME}
            SOURCES ${PARSE_SOURCES}
            TESTONLYLIBS ${KOKKOS_GTEST_LIB} ${KOKKOS_BENCHMARK_TESTONLY_LIB}
            NUM_MPI_PROCS 1
            COMM serial mpi
            ARGS ${PARSE_ARGS}
